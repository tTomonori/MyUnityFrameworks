...
public static class MapStratumMoveSystem {
    ...
    //            OneDirectionSlopeTilePhysicsAttribute.Side tSide = tSlope.getRelativeSide(tAttribute);
    ...
    //    if (tSlopes.Length == 0) return 1 / 2;
    //    //if (tSlopes.Length == 0) return aEntity.mStratumLevel.mLevel / 2;
    //    float tAns = 0;
    //    foreach(SlopeTilePhysicsAttribute tSlope in tSlopes) {
    //        bool b;
    //        tAns = tSlope.getHeight(aEntity.mMapPosition,out b);
    //        if (tSlope.mCollider.OverlapPoint(aEntity.transform.position))
    //            break;
    //    }
    //    return tAns;
    //}
    //public static float getHeight(MapEntity aEntity,out OneDirectionSlopeTilePhysicsAttribute.SlopeDirection oDirection) {
    //    SlopeTilePhysicsAttribute[] tSlopes = getCollided(aEntity);
    //    if (tSlopes.Length == 0) {
    //        oDirection = OneDirectionSlopeTilePhysicsAttribute.SlopeDirection.none;
    //        return 1 / 2;
    ...
    //            break;
    //    }
    //    oDirection = OneDirectionSlopeTilePhysicsAttribute.SlopeDirection.downHigh;
